...
class FTreeVisual_R2 : public FTreeVisual
{
public:
    virtual void Render(float LOD) override;							// LOD - Level Of Detail  [0.0f - min, 1.0f - max], Ignored
};

class FTreeVisual_ST : public FTreeVisual_R2
{
    typedef FTreeVisual_R2 inherited;
public:
    FTreeVisual_ST(void);
...
class FTreeVisual_PM : public FTreeVisual_R2
{
    typedef FTreeVisual_R2 inherited;
private:
