...
class CSkeletonX_ST : public Fvisual_R1, public CSkeletonX_ext
{
private:
    typedef Fvisual_R1 inherited1;
...
class CSkeletonX_PM : public FProgressive_R1, public CSkeletonX_ext
{
private:
    typedef FProgressive_R1 inherited1;
    typedef CSkeletonX_ext inherited2;
public:
    CSkeletonX_PM()	{}
