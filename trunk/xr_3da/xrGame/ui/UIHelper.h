...
public:
	...
	static	CUIStatic*			CreateStatic		( CUIXml& xml, LPCSTR ui_path, CUIWindow* parent, bool seq = false);
	...
	static	CUIComboBox*		CreateComboBox		( CUIXml& xml, LPCSTR ui_path, CUIWindow* parent );
	static	CUIScrollView*		CreateScrollView	( CUIXml& xml, LPCSTR ui_path, CUIWindow* parent );
